      ...
      "children": [
        {
          "name": "brandica",
          "children": [
            { "name": "wedding cake", "value": 10 },
            { "name": "windsor og", "value": 10 },
            { "name": "kushdozer", "value": 10 },
          ]
        },
        {
          "name": "hybrid",
          "children": [
            { "name": "White Widow", "value": 10 },
            { "name": "AK-47", "value": 10 },
            { "name": "Trainwreck", "value": 10 },
          ]
        },
        {
          "name": "sativa",
          "children": [
            { "name": "Sour Diesel", "value": 10 },
            { "name": "Durban Poison", "value": 10 },
            { "name": "Purple Haze", "value": 10 },
          ]
        }
      ]
    }
...
// const color = (d) => {
//   console.log({ d });
//   let cullah = d3.scaleOrdinal(d3.quantize(d3.interpolateRainbow, data.children.length + 1))
//   console.log({ cullah });
//   return 'red';
// }
